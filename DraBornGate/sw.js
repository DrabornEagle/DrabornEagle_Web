const DKD_CACHE = 'draborngate-web-v2.5.1';
const DKD_ASSETS = [
  '/DraBornGate/',
  '/DraBornGate/index.html',
  '/DraBornGate/Guvenlik-Sade-Tema/',
  '/DraBornGate/Guvenlik-Sade-Tema/index.html',
  '/DraBornGate/assets/app.css?v=2.5.1',
  '/DraBornGate/assets/v2.1-fixes.css?v=2.5.1',
  '/DraBornGate/assets/v2.2.css?v=2.5.1',
  '/DraBornGate/assets/v2.3.css?v=2.5.1',
  '/DraBornGate/assets/v2.4.css.payload.txt?v=2.5.1',
  '/DraBornGate/assets/v2.5.css.payload.txt?v=2.5.1',
  '/DraBornGate/assets/app.js?v=2.5.1',
  '/DraBornGate/assets/v2.3.js?v=2.5.1',
  '/DraBornGate/assets/v2.4.js.payload.txt?v=2.5.1',
  '/DraBornGate/assets/v2.5.js.payload.txt?v=2.5.1',
  '/DraBornGate/manifest.webmanifest?v=2.5.1'
];
