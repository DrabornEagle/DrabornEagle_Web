const DKD_CACHE = 'draborngate-web-v2.9.0-detailed-live-queue';
const DKD_ASSETS = [
  '/DraBornGate/',
  '/DraBornGate/index.html',
  '/DraBornGate/Guvenlik-Sade-Tema/',
  '/DraBornGate/Guvenlik-Sade-Tema/index.html',
  '/DraBornGate/assets/app.css?v=2.9.0',
  '/DraBornGate/assets/v2.1-fixes.css?v=2.9.0',
  '/DraBornGate/assets/v2.2.css?v=2.9.0',
  '/DraBornGate/assets/v2.3.css?v=2.9.0',
  ...
  '/DraBornGate/assets/app.js?v=2.9.0',
  ...
  '/DraBornGate/manifest.webmanifest?v=2.9.0'
];
