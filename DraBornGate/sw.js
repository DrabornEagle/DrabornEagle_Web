const DKD_CACHE = 'draborngate-web-v3.2.21-earnings-courier-role-link-fix1';
const DKD_SCOPE = '/DraBornGate/';
const DKD_FALLBACK = '/DraBornGate/index.html';
const DKD_REVISION = '3.2.21-earnings-courier-role-link-fix1';
const DKD_CORE_ASSETS = [
  ...
  `/DraBornGate/assets/app.v3.2.21.js?v=${DKD_REVISION}`,
  `/DraBornGate/assets/v3.2.21.guard.js?v=${DKD_REVISION}`,
  `/DraBornGate/assets/v3.2.21.earnings-fix.js?v=${DKD_REVISION}`,
  `/DraBornGate/assets/v3.2.21.js?v=${DKD_REVISION}`,
