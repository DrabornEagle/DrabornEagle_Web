const DKD_CACHE = 'draborngate-web-v3.2.9-simple-isolation-site-stability';
...
const DKD_ASSETS = [
  ...
  '/DraBornGate/assets/v2.8.css?v=3.2.9',
  ...
  '/DraBornGate/assets/v2.8.js?v=3.2.9',
  ...
  '/DraBornGate/assets/v3.2.4.js.payload.txt?v=3.2.9',
  '/DraBornGate/assets/v3.2.5.guard.js?v=3.2.9',
  '/DraBornGate/assets/v3.2.5.stability.js?v=3.2.9',
  '/DraBornGate/assets/v3.2.5.js?v=3.2.9',
  '/DraBornGate/assets/v3.2.5.session.js.payload.txt?v=3.2.9',
  '/DraBornGate/assets/v3.2.5.features.js.payload.txt?v=3.2.9',
  '/DraBornGate/assets/v3.2.8.js?v=3.2.9',
