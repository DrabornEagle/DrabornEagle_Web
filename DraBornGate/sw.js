const DKD_CACHE = 'draborngate-web-v3.2.1-public-rpc-version-guard';
...
const DKD_ASSETS = [
  ...
  '/DraBornGate/assets/app.css?v=3.2.1',
  '/DraBornGate/assets/v2.1-fixes.css?v=3.2.1',
  '/DraBornGate/assets/v2.2.css?v=3.2.1',
  '/DraBornGate/assets/v2.3.css?v=3.2.1',
  '/DraBornGate/assets/v2.4.css.payload.txt?v=3.2.1',
  '/DraBornGate/assets/v2.5.css.payload.txt?v=3.2.1',
  '/DraBornGate/assets/v2.6.css.payload.txt?v=3.2.1',
  '/DraBornGate/assets/v2.7.css?v=3.2.1',
  '/DraBornGate/assets/v2.8.css?v=3.2.1',
  '/DraBornGate/assets/v3.0.css?v=3.2.1',
  '/DraBornGate/assets/v3.1.1.css?v=3.2.1',
  '/DraBornGate/assets/app.js?v=3.2.1',
  '/DraBornGate/assets/v2.3.js?v=3.2.1',
  '/DraBornGate/assets/v2.4.js.payload.txt?v=3.2.1',
  '/DraBornGate/assets/v2.5.js.payload.1.txt?v=3.2.1',
  '/DraBornGate/assets/v2.5.js.payload.2.txt?v=3.2.1',
  '/DraBornGate/assets/v2.5.js.payload.3.txt?v=3.2.1',
  '/DraBornGate/assets/v2.5.js.payload.4.txt?v=3.2.1',
  '/DraBornGate/assets/v2.5.js.payload.5.txt?v=3.2.1',
  '/DraBornGate/assets/v2.6.js.payload.txt?v=3.2.1',
  '/DraBornGate/assets/v2.7.guard.js?v=3.2.1',
  '/DraBornGate/assets/v2.7.js?v=3.2.1',
  '/DraBornGate/assets/v2.8.js?v=3.2.1',
  '/DraBornGate/assets/v2.8.1.js?v=3.2.1',
  '/DraBornGate/assets/v3.1.1.moto.js?v=3.2.1',
  '/DraBornGate/assets/v3.1.1.data.js?v=3.2.1',
  '/DraBornGate/assets/v3.2.1.guard.js?v=3.2.1',
  '/DraBornGate/assets/v3.2.1.data.js?v=3.2.1',
  '/DraBornGate/assets/v3.2.1.js?v=3.2.1',
  ...
  '/DraBornGate/manifest.webmanifest?v=3.2.1'
];
