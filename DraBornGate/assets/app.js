...
const DKD_WEB_VERSION = '3.2.6';
const DKD_WEB_CACHE = 'draborngate-web-v3.2.6-clean-menu-compact-site-popup';
...
async function dkdBootWebV326() {
  dkdSetBootProgress(2, 'v3.2.6 sürüm ve önbellek koruması başlatılıyor');
  await import(`./v3.2.6.guard.js?v=${DKD_WEB_VERSION}`);
  ...
  dkdSetBootProgress(94, 'v3.2.6 modern arayüz hazırlanıyor');
  ...
  dkdSetBootProgress(99, 'v3.2.6 arayüz ve kurye akışı tamamlanıyor');
  ...
  await dkdAppendStyleLink('./assets/v3.2.6.css', 'dkdWebV326');
  await import(`./v3.2.6.js?v=${DKD_WEB_VERSION}`);
  dkdFinishBoot();
}

dkdBootWebV326().catch(dkdShowBootError);
