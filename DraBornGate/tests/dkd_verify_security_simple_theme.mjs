...
const dkdThemeJs = dkdRead('assets/v2.4.js');
const dkdThemeCss = dkdRead('assets/v2.4.css');
...
for (const dkdRequired of [
  ...
  'dkdV24SubmitMatch',
  'dkdV24NativeValue',
  'dkdV24WaitForNativeInput',
  'MutationObserver',
  'DKD_V24_SIMPLE_PATH',
  'data-dkd-v24-theme="simple"',
  'data-dkd-v24-theme="modern"',
...
assert.match(dkdIndex, /assets\/v2\.4\.css\?v=2\.4\.0/);
...
assert.match(dkdServiceWorker, /assets\/v2\.4\.js\?v=2\.4\.0/);
assert.match(dkdServiceWorker, /assets\/v2\.4\.css\?v=2\.4\.0/);
