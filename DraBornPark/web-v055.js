/* DraBornPark web v0.5.5 — direct secure message + public promo for every ?tag= link. */
(function(){
  ...
  function dkd_promo_markup(){return `<section id="dkd55-promo" class="dkd55-promo"><div class="dkd55-promo-head"><span class="dkd55-promo-icon"><i class="ri-shield-star-line"></i></span><div><span class="dkd55-kicker" style="color:#ffd757">DRABORNPARK • ARAÇ GÜVENLİĞİ</span><h3>Senin aracında da DraBornPark olsun</h3><p>Bu sayfayı bir QR/NFC etiketiyle açtıysan, kendi aracın için de DraBornPark etiketi edinebilirsin.</p></div></div><div class="dkd55-shop-grid"><a class="dkd55-shop" href="https://www.trendyol.com/" target="_blank" rel="noopener"><i class="ri-shopping-bag-3-line"></i><span><b>Trendyol</b><small>Örnek satış bağlantısı</small></span></a><a class="dkd55-shop" href="https://www.hepsiburada.com/" target="_blank" rel="noopener"><i class="ri-shopping-cart-2-line"></i><span><b>Hepsiburada</b><small>Örnek satış bağlantısı</small></span></a><a class="dkd55-shop" href="https://www.amazon.com.tr/" target="_blank" rel="noopener"><i class="ri-store-2-line"></i><span><b>Amazon</b><small>Örnek satış bağlantısı</small></span></a><a class="dkd55-shop is-future" href="./shop/"><i class="ri-store-3-line"></i><span><b>DraBornPark Mağaza</b><small>Kendi e-ticaret alanımız • yakında</small></span></a></div><p class="dkd55-promo-note">Örnek bağlantılar resmî satıcı/iş ortaklığı gösterimi değildir. DraBornPark Mağaza alanı ileride kendi e-ticaret sitemize bağlanacaktır.</p></section>`;}
  ...
  function dkd_boot(){
    ...
    const dkd_observer=new MutationObserver(()=>{if(dkd_install_panel())dkd_observer.disconnect();});dkd_observer.observe(document.documentElement,{childList:true,subtree:true});setTimeout(()=>dkd_observer.disconnect(),10000);
  }
