(() => {
 ...
 'users-accounts':()=>{DKD.settingsSection='Users and Accounts';DKD.navigate('settings');},'profile-photo':()=>document.getElementById('dkd-profile-photo-input')?.click(),'profile-photo-remove':()=>{DKD.state.profile.photo='';DKD.persist();DKD.renderSettings();DKD.toast('Profile photo removed','Your initials are being used again.');},
