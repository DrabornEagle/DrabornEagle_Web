...
dkdApp.listen(dkdPort, '0.0.0.0', () => console.log(JSON.stringify({ dkd_message: 'dkd_admin_started', dkd_port: dkdPort, dkd_direct_share: true, dkd_full_url_only: true, dkd_telegram_preview: true, dkd_cleanup_actions: true, dkd_version: 'v0.16' })));
